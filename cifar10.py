# -*- coding: utf-8 -*-
"""
Created on Wed May  9 10:14:42 2018
...
model.add(MaxPooling2D(pool_size=(2, 2)))                #maxpool池化
...
model.compile(loss='categorical_crossentropy',
              ...
              metrics=['accuracy'])
#进行训练
batch_size = 32#批量训练数量
nb_epoch = 10###训练次数因为电脑原因这个可以设置
data_augmentation = False #是否数据扩充，主要针对样本过小方案keras提供图片生成
